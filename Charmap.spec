...
Charmap to mapa znaków o dużych możliwościach. Działa pod uniksowymi
systemami operacyjnymi z zainstalowanym środowiskiem GNUstep.

Potęga Charmapa polega na obsłudze nie tylko prostej pomocy przy
wybieraniu znaków, ale także wyświetlaniu istotnych danych unikodowych
dotyczących każdego znaku, takich jak nazwa unikodowa, alias, rozkład
kanoniczny, kategoria unikodowa i różne reprezentacje. Dzięki temu
wszystkiemu programiści jak i językofile uznają Charmapa za użyteczne
narzędzie.
